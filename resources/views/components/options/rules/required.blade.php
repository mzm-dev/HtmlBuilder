<div class="mb-6">
    ...
    <div class="flex flex-col space-y-2">
        <label class="flex items-center cursor-pointer">
            <input type="radio" name="presence" value="required" wire:model.live="presence"
        ...
        <label class="flex items-center cursor-pointer">
            <input type="radio" name="presence" value="nullable" wire:model.live="presence"
                class="form-radio h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500">
        ...
        <label class="flex items-center cursor-pointer">
            <input type="radio" name="presence" value="optional" wire:model.live="presence"
                class="form-radio h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500">
